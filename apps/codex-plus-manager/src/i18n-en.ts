...
export const EN_PLAIN: Record<string, string> = {
  ...
  "VLM Model": "VLM Model",
  "VLM 仅支持 Chat Completions 和聚合模式": "VLM only supports Chat Completions and aggregate mode",
  ...
  "打开安装包下载": "Open installer download",
  ...
  "仅在 Chat Completions 和聚合模式生效。": "Only effective in Chat Completions and aggregate mode.",
